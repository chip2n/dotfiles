...
hi TabLineSel   cterm=NONE    ctermfg=NONE       ctermbg=6
...
hi StatusLine  cterm=NONE     ctermfg=NONE       ctermbg=6
...
hi Comment   cterm=NONE ctermfg=5   ctermbg=NONE
...
hi Statement cterm=None ctermfg=4 ctermbg=NONE
hi Conditional gui=NONE guifg=#ffa500 guibg=NONE guisp=NONE 
hi Conditional cterm=NONE ctermfg=4 ctermbg=NONE
hi Operator guifg=#5ba7c2 guibg=NONE guisp=NONE gui=NONE ctermfg=6 ctermbg=NONE cterm=NONE
...
hi String guifg=#ff7070 guibg=NONE guisp=NONE gui=bold ctermfg=3 ctermbg=NONE cterm=bold
