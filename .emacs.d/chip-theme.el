...
(with-theme 'chip
  ...
  `(org-drawer ((,class (:foreground ,color-comment))))
  `(org-property-value ((,class (:foreground ,color-comment))))
  `(org-document-info ((,class (:foreground ,color-comment))))
  `(org-document-info-keyword ((,class (:foreground ,color-comment))))
  `(org-document-title ((,class (:foreground ,color-comment))))
  `(org-special-keyword ((,class (:foreground ,color-comment))))
  ...
  `(org-block-begin-line ((,class (:foreground ,color-comment :inherit fixed-pitch))))
  `(org-block ((,class (:foreground ,color-foreground :inherit fixed-pitch :extend t))))
  `(org-block-end-line ((,class (:foreground ,color-comment :inherit fixed-pitch))))
