...
## Type: QssColor
c.colors.completion.category.bg = nord['base02']
...
## Type: QtColor
c.colors.completion.category.fg = theme['base2']
...
## Type: QssColor
c.colors.completion.item.selected.bg = theme['base1']

## Bottom border color of the selected completion item.
## Type: QssColor
c.colors.completion.item.selected.border.bottom = theme['base1']

## Top border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.item.selected.border.top = theme['base1']
...
## Type: QssColor
c.colors.completion.match.fg = theme['pink1']

## Background color of the completion widget for odd rows.
## Type: QssColor
c.colors.completion.odd.bg = nord['base03']
...
## for transparency.
## Type: QssColor
c.colors.hints.bg = theme['base0']

## Font color for hints.
## Type: QssColor
c.colors.hints.fg = theme['base4']

## Font color for the matched part of hints.
## Type: QssColor
c.colors.hints.match.fg = theme['pink1']
...
## Type: QssColor
c.colors.statusbar.normal.fg = theme['base2']
...
## Type: QssColor
c.colors.statusbar.url.fg = theme['base2']
...
## (http).
## Type: QssColor
c.colors.statusbar.url.success.http.fg = theme['base3']

## Foreground color of the URL in the statusbar on successful load
## (https).
## Type: QssColor
c.colors.statusbar.url.success.https.fg = theme['base3']
...
## Type: QtColor
c.colors.tabs.even.bg = theme['base0']

## Foreground color of unselected even tabs.
## Type: QtColor
c.colors.tabs.even.fg = theme['base2']
...
## Type: QtColor
c.colors.tabs.odd.bg = theme['base0']

## Foreground color of unselected odd tabs.
## Type: QtColor
c.colors.tabs.odd.fg = theme['base2']

## Background color of selected even tabs.
## Type: QtColor
c.colors.tabs.selected.even.bg = theme['base1']

## Foreground color of selected even tabs.
## Type: QtColor
c.colors.tabs.selected.even.fg = theme['base4']

## Background color of selected odd tabs.
## Type: QtColor
c.colors.tabs.selected.odd.bg = theme['base1']

## Foreground color of selected odd tabs.
## Type: QtColor
c.colors.tabs.selected.odd.fg = theme['base4']
